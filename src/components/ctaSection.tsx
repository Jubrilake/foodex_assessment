    ...
    <section className="mx-auto md:py-36 py-20 text-center ">
      ...
      <div className=" mx-auto space-y-6 relative">
        <img
          src={dbcloud}
          alt=""
          className="absolute left-0 bottom-0 md:w-[10%] hidden md:block h-auto lg:w-[30%] "
        />
        <img
          src={cloud}
          alt=""
          className="absolute right-0 bottom-0 hidden md:block md:w-[10%] h-auto lg:w-[20%]"
        />
        ...
        <p className="text-black lg:px-80 md:px-28 font-semibold px-12 text-sm md:text-lg">
